	...
	if($result_bind)
	{
		...
		if($row_bind_count > 0)
		{
			...
			{				
				...
				//кол-во комнат, тип объекта, тип сделки, вторичка-новострой
